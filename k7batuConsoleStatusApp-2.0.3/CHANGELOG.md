...
- Promoted the rebuilt Status App release tree to version 2.0.3.
- Added the TaskManager tab and Sidekick Manager launcher.
- Added the main-window Minimize control.
- Added Sidekick setup launcher and API version discovery documentation.
